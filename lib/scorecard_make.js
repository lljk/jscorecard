...
function make_footer(){
	...
	function make_help_box(callback) {
		...
		about_help.append('<br><p>Scorecard Generator by J. Kaiden</p>');
		about_help.append('<p>version 0.13.7</p>');
		about_help.append('<br><p>All documents retrieved by this application are proprietary content of MLB Advanced Media, L.P ("MLBAM").</p>');
...
function make_popup(title, body, top){
	...
	//$('#popup_title' + id).append('<button class="popup_close" id="popup_close' + id + '">x</div>');
